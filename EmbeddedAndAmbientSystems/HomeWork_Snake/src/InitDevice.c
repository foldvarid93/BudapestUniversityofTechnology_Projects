...
extern void CMU_enter_DefaultMode_from_RESET(void) {
	...
	CMU_ClockDivSet(cmuClock_HFPER, cmuClkDiv_1);//Periféria órajelosztója legyen 1
	CMU_ClockEnable(cmuClock_GPIO, true);//Gpio órajel engedélyezés
	CMU_ClockEnable(cmuClock_ADC0, true);//ADC órajel engedélyezés
	CMU_ClockEnable(cmuClock_TIMER0, true);//Timer0 órajel engedélyezés
...
extern void TIMER0_enter_DefaultMode_from_RESET(void) {
	...
	TIMER0_init.prescale = timerPrescale128;//128 as elõosztó
	TIMER_Init(TIMER0, &TIMER0_init);
	TIMER_CounterSet(TIMER0, 0);// reseteljük a számlálót
	TIMER_TopSet(TIMER0, 125); // 14MHz/presc/TOP
...
extern void PORTIO_enter_DefaultMode_from_RESET(void) {
	...
	GPIO_PinModeSet(gpioPortB,9, gpioModeInput,0);//PB0 input
	GPIO_PinModeSet(gpioPortB,10, gpioModeInput,0);//PB1 input
	// [Port B Configuration]$
	...
	GPIO_PinModeSet(gpioPortD,0,gpioModeInput,0);//analog input a random számhoz
	// [Port D Configuration]$

	// $[Port E Configuration]
	GPIO_PinModeSet(gpioPortE,2, gpioModePushPull,0);//LED1 output
	GPIO_PinModeSet(gpioPortE,3, gpioModePushPull,0);//LED2 output
	// [Port E Configuration]$
